 ...
 * Copyright (c) 2009-2011 by GroupToList, Inc. All Rights Reserved.
...
//@interface GroupToListObject : NSObject
//@end

@interface GroupToListObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GroupToListObject class]])
		{
			for (NSString *key in [[(GroupToListObject*)o modules] allKeys])
			{
