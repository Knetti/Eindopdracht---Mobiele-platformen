...
@interface GroupToListObject : KrollCoverageObject {
#else
@interface GroupToListObject : KrollObject {
#endif
@private
...
extern NSString * GroupToList$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	GroupToListObject *_grouptolist;
	BOOL shutdown;
