...
// in simulator we redefine to format for GroupToList Developer console
...
{\
	NSString * exceptionName = [@"org.grouptolist." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.grouptolist";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIGroupToListNativeItemNone = -1, 
	UIGroupToListNativeItemSpinner = -2,
	UIGroupToListNativeItemProgressBar = -3,
	
	UIGroupToListNativeItemSlider = -4,
	UIGroupToListNativeItemSwitch = -5,
	UIGroupToListNativeItemMultiButton = -6,
	UIGroupToListNativeItemSegmented = -7,
	
	UIGroupToListNativeItemTextView = -8,
	UIGroupToListNativeItemTextField = -9,
	UIGroupToListNativeItemSearchBar = -10,
	
	UIGroupToListNativeItemPicker = -11,
	UIGroupToListNativeItemDatePicker = -12,
	
	UIGroupToListNativeItemInfoLight = -13,
	UIGroupToListNativeItemInfoDark = -14,
	
	UIGroupToListNativeItemDisclosure = -15,
	
	UIGroupToListNativeItemContactAdd = -16
};
